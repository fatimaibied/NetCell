...
public class PLMN extends MainClass {
    ...
    public void PLMNStats3G() throws Exception {
        ...
        State.Stats("Huawei", "3G", "PLMN", false,"Hourly", "All", false);
    }
    @Test
    public void PLMNStatsDaily3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"Daily", "All", false);
    }

    @Test
    public void PLMNStatsWeekly3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"Weekly", "All", false);
    }

    @Test
    public void PLMNStatsMonthly3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"Monthly", "All", false);
    }
    @Test
    public void PLMNStatsDailyBH3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"DailyBH", "All", false);
    }

    @Test
    public void PLMNStatsWeeklyBH3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"WeeklyBH", "All", false);
    }

    @Test
    public void PLMNStatsMonthlyBH3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"MonthlyBH", "All", false);
    }

    @Test
    public void PLMNStatsRawBH3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"Raw", "All", false);
    }
    //------------------- Search for KPI -----------------------------------------------------------------
    @Test
    public void PLMNSearchForKPI3G() throws Exception {

        State.Stats("Huawei", "3G", "PLMN", false,"Hourly", "RRC_Setup_Fail_Ratio_Other", false);
    }
}
