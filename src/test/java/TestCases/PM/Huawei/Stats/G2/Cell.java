...
public class Cell extends MainClass {
    ...
    public void CellSearchForKPI2G() throws Exception {
        ...
        State.Stats("Huawei", "2G", "Cell", false,"Hourly", "CS_Pages");
    }
}
