...
public class Cluster extends MainClass {
    ...
    public void ClusterSearchForKPI4G() throws Exception {
        ...
        State.Stats("Huawei", "4G", "Cluster", false,"Hourly", "DL_Traffic_MB_CA_User_PCell");
    }
}
