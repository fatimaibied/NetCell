...
public class Cell extends MainClass {
    ...
    public void CellSearchForKPI4G() throws Exception {
        ...
        State.Stats("Huawei", "4G", "Cell", false,"Hourly", "Paging_UU_Att");
    }
}
